...
def get_data():
    ...
    return_list += math_engine.get_params() + [slider_i.get()]
    return return_list
...
slider_i = NonLinearSlider(win, 20, 410, plot, label= 'Ki', initial_value=0.2, min=-25, max=25)
