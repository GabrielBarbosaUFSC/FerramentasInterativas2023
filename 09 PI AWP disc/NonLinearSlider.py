...
class NonLinearSlider:
    def __init__ (self, win, pos_x, pos_y, plot_func, label, min = -25, max = 25, non_zero = False, initial_value = 0, IsInt = False):
        self.isint = IsInt
    ...
    def set_params(self, label, min = -25, max = 25, non_zero = False, initial_value = 0, IsInt = None):
