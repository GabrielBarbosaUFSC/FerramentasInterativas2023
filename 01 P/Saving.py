...
class Save:
    def __init__(self, win, pos_x, pos_y, number, t):
        self.t = t
        self.datas = [[], [], [], []] # [y, u, sp, q]
        self.condicions = [] # [tau, u_max, u_min, ke, kq, l, kp, bias]
        self.number = number
        self.in_use = False
        self.win = win
        self.posx = pos_x
    ...
    def set(self, params):
        ...
        self.condicions = params[4:12]
        self.label_var.set(f'#{self.number}: {params[12]}')
    ...
    def show_wave_form(self):
        ...
        labels = ["\u03c4", "Umax", "Umin", "Ke", "Kq", "L", "kp", "bias"]
        text = ""
        for i in range(8):
