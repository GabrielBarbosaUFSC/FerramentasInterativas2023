...
def get_data():
    ...
    return_list += math_engine.get_params() + [slider_kp.get(), slider_ki.get()]
    return return_list
...
slider_kp = NonLinearSlider(win, 20, 400, plot, label= 'Kp', initial_value=1, min=-50, max=50)
slider_ki = NonLinearSlider(win, 20, 450, plot, label= 'Ki', initial_value=1, min=-50, max=50)
